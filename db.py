...
NOTE: Render's free web service tier wipes the local filesystem on every
restart/redeploy/spin-down. That means accounts and history reset
periodically on the free plan — acceptable for a personal/demo tool.
If you need accounts to survive indefinitely, attach a Render persistent
disk (paid plans) or use a managed Postgres database instead.
"""
